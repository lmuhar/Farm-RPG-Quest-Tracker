...
const PASSIVE_INPUTS = new Set(['Wood', 'Stone', 'Nails', 'Straw', 'Worms', 'Grubs', 'Minnows']);
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 flex-1 min-w-0">
          <RefreshCw size={10} style={{ color: 'var(--accent-green)', flexShrink: 0 }} />
          <span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>
            Wood · Stone · Nails · Straw · Worms · Grubs · Minnows regenerate automatically — items using only these keep Craftworks running without intervention
          </span>
        </div>
