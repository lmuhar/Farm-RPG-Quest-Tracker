...
import { ChevronDown, ChevronRight, Clock, Hammer, Landmark } from 'lucide-react';
      ...
      {!collapsed && (
        <div>
          {items.length === 0 ? (
            ...
            items.map(({ item, totalNeeded, have, deficit, pct, isHoney, honey, honeyRadishHave, honeyGrows, cropTime, grows, totalTime, recipe }) => {
