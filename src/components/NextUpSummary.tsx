      ...
      {!collapsed && (
        <div>
          {items.length === 0 ? (
            ...
            items.map(({ item, totalNeeded, have, deficit, pct, isHoney, isCutlass, honey, honeyRadishHave, honeyGrows, cutlass, cutlassStaffHave, cropTime, grows, totalTime, recipe }) => {
